...
<em>The memory footprint of RNA2Drawer continually increases.</em> This seems to be an issue with the underlying Tcl/Tk canvas that the structure editing canvas uses. (Memory is not freed where I had thought it would be.) This is currently being addressed.
