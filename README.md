...
<dl><dd>The currently selected subsequence (positions 3,846 to 3,850) is highlighted in green. Positions 3,836 to 3,840 and 3,887 to 3,891 (highlighted in pink) are complementary to the currently selected subsequence and can be paired in the secondary structure. Positions 3,728 to 3,732 (highlighted in blue) are also complementary, but their pairing would invalidate the secondary structure.</dd></dl>
