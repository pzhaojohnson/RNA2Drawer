...
In `File` -> `Open`, you can open: <em>i</em>) a plain sequence to be drawn single-stranded, <em>ii</em>) a FASTA file, <em>iii</em>) dot-bracket notation, <em>iv</em>) a CT file generated by Mfold, or <em>v</em>) the RNA2Drawer file of a saved tab.
