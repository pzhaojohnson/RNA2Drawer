...
The bottom bar of the structure editing canvas contains helpful information: (from left to right) what clicking the mouse will currently do, the number of pairable subsequences, the currently selected range, and the entire sequence range.
