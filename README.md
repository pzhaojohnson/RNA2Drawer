...
<b><em>It seems that the below means of running RNA2Drawer on macOS is not possible anymore starting with macOS Catalina. (This is due to [Wine](https://www.winehq.org/) no longer being supported.) Luckily, the second, web-based version of RNA2Drawer will become available in the coming months. So stay tuned!</em></b>
