...
<em>Can I draw DNA instead of RNA?</em> Yes, input windows allow you to parse as DNA, and it is possible to convert an RNA structure into a DNA one (see [Other Customizations](#other-customizations)).
